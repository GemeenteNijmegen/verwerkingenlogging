        ...
        requestTemplates: {
          'application/json': JSON.stringify({
            ...
            Item: {
              ...
              url: { S: "$input.params('url')" },
              actieNaam: { S: "$input.params('actieNaam')" },
              handelingNaam: { S: "$input.params('handelingNaam')" },
              verwerkingId: { S: "$input.params('verwerkingId')" },
              verwerkingNaam: { S: "$input.params('verwerkingNaam')" },
              verwerkingsactiviteitId: { S: "$input.params('verwerkingsactiviteitId')" },
              verwerkingsactiviteitUrl: { S: "$input.params('verwerkingsactiviteitUrl')" },
              vertrouwelijkheid: { S: "$input.params('vertrouwelijkheid')" },
              bewaartermijn: { S: "$input.params('bewaartermijn')" },
              uitvoerder: { S: "$input.params('uitvoerder')" },
              systeem: { S: "$input.params('systeem')" },
              gebruiker: { S: "$input.params('gebruiker')" },
              gegevensbron: { S: "$input.params('gegevensbron')" },
              soortAfnemerId: { S: "$input.params('soortAfnemerId')" },
              afnemerId: { S: "$input.params('afnemerId')" },
              verwerkingsactiviteitIdAfnemer: { S: "$input.params('verwerkingsactiviteitIdAfnemer')" },
              verwerkingsactiviteitUrlAfnemer: { S: "$input.params('verwerkingsactiviteitUrlAfnemer')" },
              verwerkingIdAfnemer:{ S: "$input.params('verwerkingIdAfnemer')" },
              tijdstip: { S: "$input.params('tijdstip')" },
              tijdstipRegistratie: { S: '$context.requestTime' },
              verwerkteObjecten: { S: "$input.params('verwerkteObjecten')" }
            },
          }),
        },
